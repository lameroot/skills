...
def create_client() -> ConfluenceClient:
    ...
    creds = require_credentials(["CONFLUENCE_USERNAME", "CONFLUENCE_API_TOKEN"], cfg)
    ...
    return ConfluenceClient(base, creds["CONFLUENCE_USERNAME"], creds["CONFLUENCE_API_TOKEN"])
